    ...
    <div className="About">
      <div className="AboutMeContainer">
        ...
        <div className="AboutMeContent">
          ...
          <p>The primary draw for me is the interactivity and the UI/UX aspect of web, with the freedom to design, build, and create experiences without the restrictions of traditional media.</p>
        </div>
      </div>
    </div>
  );
